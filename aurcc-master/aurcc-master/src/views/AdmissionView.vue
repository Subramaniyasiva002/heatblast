<template>
  <main class="flex-grow">
    ...
    <section class="mx-auto py-6 md:py-12 md:px-10 bg-indigo-100 rounded-lg animate-popIn" :style="{ backgroundImage: `url(${backgroundImageContent})` }">
        ...
        <div class="px-8 md:px-0">
          <div class="flex-shrink-0 w-full h-max md:w-64 bg-gradient-to-r from-[#21209c] to-blue-600 rounded-lg shadow-lg p-4 mb-4 md:mb-0">
            ...
            <div class="space-y-2 font-serif">
              ...
              <button @click="currentSection = 'courses_offered'" :class="{'bg-yellow-400 text-[#23120b]': currentSection === 'courses_offered', 'bg-gray-100': currentSection !== 'courses_offed'}" class="w-full py-2 px-4 rounded-md font-semibold hover:bg-yellow-400 hover:text-[#23120b]">Courses Offered</button>
...
import backgroundImage from '@/assets/offices.webp';  // Correct path for the hero image
import backgroundImageContent from '@/assets/aurcc_bg.webp';  // Correct path for the content section background
