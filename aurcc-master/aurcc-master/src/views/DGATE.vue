          ...
          <div class="flex-shrink-0 w-full h-max md:w-64 bg-gradient-to-r from-[#21209c] to-blue-600 rounded-lg shadow-lg p-4 mb-4 md:mb-0 md:mr-4">
            ...
            <div class="space-y-2 font-serif">
              <button @click="activeTab = 'activities'" 
                      :class="{'bg-yellow-400 text-[#23120b]': activeTab === 'activities', 'bg-gray-100': activeTab !== 'activities'}" 
                      class="w-full py-2 px-4 rounded-md font-semibold hover:bg-yellow-400 hover:text-[#23120b]">Activities</button>
              <button @click="activeTab = 'projects'" 
                      :class="{'bg-yellow-400 text-[#23120b]': activeTab === 'projects', 'bg-gray-100': activeTab !== 'projects'}" 
                      class="w-full py-2 px-4 rounded-md font-semibold hover:bg-yellow-400 hover:text-[#23120b]">Projects</button>
              <button @click="activeTab = 'hackathon'" 
                      :class="{'bg-yellow-400 text-[#23120b]': activeTab === 'hackathon', 'bg-gray-100': activeTab !== 'hackathon'}" 
                      class="w-full py-2 px-4 rounded-md font-semibold hover:bg-yellow-400 hover:text-[#23120b]">Hackathon Participation</button>
              <button @click="activeTab = 'staff'" 
                      :class="{'bg-yellow-400 text-[#23120b]': activeTab === 'staff', 'bg-gray-100': activeTab !== 'staff'}" 
                      class="w-full py-2 px-4 rounded-md font-semibold hover:bg-yellow-400 hover:text-[#23120b]">Staff Members</button>
            </div>
          </div>
        </div>
...
import backgroundImage from '@/assets/offices.webp';  // Hero background image
