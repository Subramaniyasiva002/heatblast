  ...
  <div class="flex-grow">
    ...
    <section 
      ...
      <div class="mx-10 md:py-20 py-16 text-white relative z-10 flex flex-col">
        ...
        <p class="md:text-xl text-sm font-serif mb-8 mt-6 animate-fadeIn delay-1s">
          Explore the detailed curriculum and syllabus for our undergraduate and postgraduate programs.
        </p>
      </div>
    </section>

    <!-- Content Section with Background Image -->
    <div class="bg-cover bg-center py-8 animate-fadeIn" :style="{ backgroundImage: `url(${backgroundImageContent})` }">
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200 animate-fadeInUp">
                  <tr v-for="(programme, index) in data['UG programmes']" :key="index">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ programme['S.No'] }}</td>
                    <td class="px-1 md:px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                      <a :href="programme.Link" target="_blank" class="text-blue-600 hover:underline cursor-pointer">
...
import backgroundImage from '@/assets/syllabus.webp';  // Hero Section Background Image
import backgroundImageContent from '@/assets/aurcc_bg.webp';  // Content Section Background Image

export default {
  data() {
    return {
      data: data,  // Data from the JSON file
      backgroundImage: backgroundImage,  // Hero section background
      backgroundImageContent: backgroundImageContent,  // Content section background
    };
  },
  methods: {
    // Method to handle redirecting to course link
